...
<div class="container-fluid" id="cont-3">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
            <a href="user_cand.php"><button style="margin-top:80px;" class="btn-special-2">A.S.C President </button></a>
            </div>
            <div class="col-md-12">
            <a href="user_cand_2.php"><button style="margin-top:80px;" class="btn-special-2">J.E.C President </button></a>
            </div>
            <div class="col-md-12">
            <a href="user_cand_3.php"><button style="margin-top:80px; " class="btn-special-2">A.S.C Speaker Of Parliament </button></a>
            </div>
        </div>
    </div>
