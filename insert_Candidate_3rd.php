...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" >
                ...
                <p style="padding-top: 20px;">A.S.C Speaker Of Parliament</p>
	...
	?>
                ...
                <table>
                    ...
                    <tr>
                        <td class="td-1">Candidate Testimonial:</td>
                        <td class="td-1"><textarea style="text-align: left;" name="txtRollNo" id="" cols="23" rows="4" placeholder="Enter Your Testimonial"></textarea></td>
                    </tr>
                    <tr>
                        <td class="td-1">Student  ID :</td>
