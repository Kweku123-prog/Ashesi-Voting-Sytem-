...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card-5">
            <h2><strong>Result For A.S.C President</strong></h2>
            <hr>
...
<body>
      <!-- Derives result for candidates  -->
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card-5">
            <h2><strong>Result For J.E.C President</strong></h2>
            <hr>
        <?php foreach($rs as $row){
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="card-5">
            <h2><strong>Result For A.S.C Speaker Of Parliament</strong></h2>
            <hr>
        <?php foreach($rs as $row){
